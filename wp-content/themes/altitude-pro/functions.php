...
function altitude_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'altitude-custom', get_stylesheet_directory_uri() . '/custom.css', array(), CHILD_THEME_VERSION );
...
function sp_custom_footer() {
	?>
	<p><a href="#front-page-7" title="Contact Us">Contact Us</a> &bull; <a href="tel:773-398-3845" title="Phone">773.398.3845</a></p>
	<p>&copy; <?php echo date('Y'); ?> Allison Burr. All Rights Reserved.</p>
	<?php
}